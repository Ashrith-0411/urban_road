...
main = tkinter.Tk()
main.title("Extraction of Main Urban Roads from High Resolution Satellite Images by Machine Learning")
...
font = ('times', 16, 'bold')
title = Label(main, text='Extraction of Main Urban Roads from High Resolution Satellite Images by Machine Learning')
